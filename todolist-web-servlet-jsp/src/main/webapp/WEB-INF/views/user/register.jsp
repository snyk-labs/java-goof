            ...
            <form class="well form-horizontal" method="post" action="/register.do">
                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="firstname" type="text" class="input-medium"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="lastname" type="text" class="input-medium"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="password" id="confirmationPassword" class="input-medium" placeholder="min 6 characters"/>
