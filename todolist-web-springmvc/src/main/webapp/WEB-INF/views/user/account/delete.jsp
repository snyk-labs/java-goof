            ...
            <div class="well">
                ...
                <form class="form-horizontal" method="post" action="/user/account/delete.do">
                    <div class="alert alert-block alert-error fade in">
                        ...
                        <p>You are about to remove your account from "Online Todo List". This will completely delete all your data and you will be no more able to use your current account. Are you sure to remove your account?</p>
                        <p>
